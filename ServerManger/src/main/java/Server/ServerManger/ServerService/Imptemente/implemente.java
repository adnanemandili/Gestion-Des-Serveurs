package Server.ServerManger.ServerService.Imptemente;

import Server.ServerManger.Reposetory.ServerRepo;
import Server.ServerManger.ServerService.ServerService;
...
@Transactional
@Slf4j
public class implemente implements ServerService {
